...
const translations = {
  es: {
    ...
    soul: "Corridos y Norteños, 1200 canciones para tu alma",
    songs: "🎵 Corridos y Norteños, 1200 canciones en un usb",
    desc: "¡Sumérgete en los vibrantes sonidos de AbejaLoca! Corridos y Norteños, 1200 canciones que harán vibrar tu corazón de alegría. Perfecto para cualquier ocasión, este álbum es tu boleto a un viaje musical sin igual.",
  ...
  en: {
    ...
    soul: "Corridos y Norteños for Your Soul",
    songs: "🎵 Corridos y Norteños, 1200 songs in a USB",
    desc: "Dive into the vibrant sounds of AbejaLoca! Corridos y Norteños, 1200 songs that will make your heart beat with joy. Perfect for any occasion, this album is your ticket to an unparalleled musical journey.",
    track: "Songs List:",
